...
class RegulatorySection:
    ...
    def _compare_reports(
        ...
        if same_direction and confidence_diff <= 0.2:
            ...
            reasoning = f"阿呂: {report_a.reasoning} | 萱萱: {report_b.reasoning}"
            ...
            reasoning = (
                f"方向一致但信心差異: 阿呂 {report_a.sub_confidence:.2f} "
            ...
            reasoning = f"大分歧採保守: 阿呂 {report_a.direction} | 萱萱 {report_b.direction}"
            self.logger.warning(f"GA-02 雙人大分歧: {reasoning}")
