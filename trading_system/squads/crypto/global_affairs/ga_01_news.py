...
class NewsSection:
    ...
    def _compare_reports(
        ...
        if same_direction and confidence_diff <= 0.2:
            ...
            reasoning = f"阿蕭: {report_a.reasoning} | 芸芸: {report_b.reasoning}"
            ...
            reasoning = (
                f"方向一致但信心差異: 阿蕭 {report_a.sub_confidence:.2f} "
            ...
            reasoning = f"大分歧採保守: 阿蕭 {report_a.direction} | 芸芸 {report_b.direction}"
            self.logger.warning(f"GA-01 雙人大分歧: {reasoning}")
