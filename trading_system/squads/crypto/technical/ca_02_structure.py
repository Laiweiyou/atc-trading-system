...
class StructureSection:
    ...
    def _compare_reports(
        ...
        if same_direction and confidence_diff <= 0.2:
            ...
            reasoning = f"小林: {report_a.reasoning} | 慧慧: {report_b.reasoning}"
            ...
            reasoning = (
                f"方向一致但信心差異: 小林 {report_a.sub_confidence:.2f} "
            ...
            reasoning = f"大分歧採保守: 小林 {report_a.direction} | 慧慧 {report_b.direction}"
            self.logger.warning(f"CA-02 雙人大分歧: {reasoning}")
